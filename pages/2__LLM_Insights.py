...
st.set_page_config(page_title="AI Weather Forecaster", page_icon="🤖", layout="wide")

st.title("🤖 AI Weather Forecaster")
st.caption("Get a personalized weather forecast generated by Google Gemini based on Open‑Meteo data.")
...
fig = px.line(df.reset_index(), x="time", y="temperature",
              ...
              labels={"temperature": f"Temperature ({'°F' if 'Imperial' in units else '°C'})"})
